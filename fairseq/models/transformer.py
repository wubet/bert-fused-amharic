...
class TransformerS2Model(FairseqEncoderDecoderModel):
    ...
    def forward(self, src_tokens, src_lengths, prev_output_tokens, bert_input, **kwargs):
        ...
        """
        bert_encoder_padding_mask = bert_input.eq(self.berttokenizer.pad()).float()
...
@register_model_architecture('transformers2', 'transformer_wmt_en_am')
def transformer_wmt_en_am(args):
    base_architecture_s2(args)
