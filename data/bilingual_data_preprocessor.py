...
class BilingualDataPreprocessor:
    ...
    def preprocess_data(self, en_file, am_file, pre_fix):
        en_file = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(os.getcwd()))), en_file)
        am_file = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(os.getcwd()))), am_file)
        pre_fix = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(os.getcwd()))), pre_fix)
...
if __name__ == '__main__':
    ...
    processor.preprocess_data(args.en_file, args.am_file, prefix)
